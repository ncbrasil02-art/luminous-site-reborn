...
// a source — it's where the __l5e proxy actually resolves. NOTE: this is the
// project's Lovable subdomain (Settings > General > URL subdomain in the
// Lovable editor), which the project owner can rename at any time — if this
// script starts failing every asset again, check there first.
const SOURCE_ORIGIN = "https://sistema-leilao-plataformas.lovable.app";
