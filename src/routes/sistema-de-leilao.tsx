...
const lpFaq = [
  ...
  { q: "Quanto tempo leva a implantação completa?", a: "De **2 a 3 dias úteis**, incluindo configuração white-label, integrações com meios de pagamento (PIX/Boleto/Cartão), KYC (Receita/Serasa), treinamento da equipe e entrega do ambiente pronto para o primeiro leilão." },
...
export const Route = createFileRoute("/sistema-de-leilao")({
  head: () => buildLPMeta({
    title: "Seu Sistema de Leilões e Plataforma de Leilão Online Homologada",
  ...
  component: () => (
    <>
      ...
      intro={<>Aumente seus pregões com a melhor <strong className="text-foreground text-primary">plataforma de leilões</strong> do mercado. O nosso <strong className="text-foreground text-primary">sistema de leilão online</strong> é homologado em 27 Tribunais de Justiça e utilizado por grandes <strong className="text-foreground text-primary">leiloeiros oficiais</strong>. Se você busca um <strong className="text-foreground text-primary">sistema para leiloeiro</strong> completo, com pregão eletrônico simultâneo e <strong className="text-foreground text-primary">plataforma de pregões online</strong>, a NC Brasil oferece a solução definitiva: <strong className="text-foreground text-primary">seu site de leilão</strong> próprio, sem aluguel mensal e com tecnologia de ponta.</>}
