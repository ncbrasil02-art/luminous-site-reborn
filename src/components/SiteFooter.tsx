...
const cols = [
  {
    ...
    links: [
      ...
      { to: "/solucoes-web/hospedagem", label: "Hospedagem" },
      { to: "/servicos/aplicativos", label: "Aplicativos" },
      { to: "/servicos/identidade-visual", label: "Identidade Visual" },
    ],
  },
  {
    ...
    links: [
      ...
      { to: "/sistema-de-raspadinha", label: "Raspadinha" },
