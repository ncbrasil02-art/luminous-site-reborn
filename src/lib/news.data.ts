...
export const newsData: NewsPost[] = [
  {
    ...
    "content": "<h2>Inovação no Mercado de Luxo: Tecnologia de Ponta para Leilões Online</h2>\n\n<p>A NcBrasil acaba de anunciar o lançamento de uma funcionalidade revolucionária voltada exclusivamente para o mercado de alto padrão: o novo recurso para <strong>Leilões de Pedras Preciosas</strong>.</p>\n\n<p>Com esta atualização, o nosso <a href=\"/sistema-de-leilao\" class=\"font-bold text-primary hover:underline\">sistema de leilão</a> atinge um novo patamar de precisão e segurança, permitindo a catalogação detalhada e a verificação de autenticidade em tempo real para diamantes, esmeraldas e outras gemas de valor inestimável.</p>\n\n<div class=\"my-12 flex justify-center\">\n  <img src=\"https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?q=80&w=800&auto=format&fit=crop\" alt=\"Pessoa usando smartphone para acessar plataforma de leilão\" class=\"max-w-md border border-primary/20 shadow-[0_0_25px_rgba(59,130,246,0.3)]\" />\n</div>\n\n<h3>Segurança e Transparência na Palma da Mão</h3>\n\n<p>Este avanço tecnológico foi projetado para atender às exigências rigorosas de colecionadores e investidores internacionais.</p>\n\n<p>A <a href=\"/sistema-de-leilao\" class=\"font-bold text-primary hover:underline\">plataforma de leilão</a> agora integra certificados digitais e visualização em altíssima definição, garantindo que cada detalhe da pedra seja analisado minuciosamente pelos licitantes. A NcBrasil reafirma seu compromisso em fornecer a tecnologia mais avançada do mercado para quem busca excelência e transparência em transações de ativos valiosos.</p>\n\n<p>A experiência do usuário foi completamente redesenhada para suportar lances em tempo real com latência zero, algo essencial quando se trata de itens competitivos. O <strong>sistema de leilão</strong> da NcBrasil é hoje a escolha número um para casas de leilão que não abrem mão de robustez técnica e design sofisticado.</p>\n\n<div class=\"my-12 flex justify-center\">\n  <img src=\"https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=800&auto=format&fit=crop\" alt=\"Pessoas navegando na internet e trabalhando com tecnologia\" class=\"max-w-md border border-primary/20 shadow-[0_0_25px_rgba(59,130,246,0.3)]\" />\n</div>\n\n<h3>O Futuro dos Leilões de Luxo</h3>\n\n<p>Se você busca uma solução robusta e confiável, conheça a nossa <a href=\"/sistema-de-leilao\" class=\"font-bold text-primary hover:underline\">plataforma de leilão online</a> completa.</p>\n\n<p>Este novo recurso é apenas o começo de uma série de inovações que estamos trazendo para o setor. Fique atento às nossas próximas atualizações e descubra como o nosso <strong>sistema de leilão</strong> pode transformar o seu negócio e elevar a sua autoridade no mercado de leilões eletrônicos.</p>\n\n<div class=\"mt-12 p-8 border border-primary/30 bg-primary/5 text-center\">\n  <h4 class=\"text-xl font-bold mb-4\">Pronto para escalar seu negócio de Leilões?</h4>\n  <p class=\"mb-6\">Descubra por que a NcBrasil é referência em tecnologia para plataformas de leilão de alta performance.</p>\n  <a href=\"/sistema-de-leilao\" class=\"inline-block px-8 py-3 bg-primary text-white font-bold uppercase tracking-widest hover:bg-primary/90 transition-colors\">\n    Criar meu site de leilão\n  </a>\n</div>",
    "categories": [
      "Sistemas",
      "Leilões"
    ],
  ...
  },
  {
    ...
    "categories": [],
    "tags": [],
    "image_url":  "https://www.ncbrasil.com.br/news/Cv81ZQhWAAAmoTo.webp",
    "thumb_id": ""
  },
  {
    "id": "49607",
  ...
  },
  {
    ...
    "categories": [],
    "tags": [],
    "image_url":  "https://www.ncbrasil.com.br/news/Venda-de-Carros-site.webp",
    "thumb_id": ""
  },
  {
    "id": "49986",
  ...
  },
  {
    ...
    "categories": [],
    "tags": [],
    "image_url":  "https://www.ncbrasil.com.br/news/Marketing-Digital.webp",
    "thumb_id": ""
  },
  {
    "id": "50094",
  ...
  },
  {
    ...
    "categories": [],
    "tags": [],
    "image_url":  "https://www.ncbrasil.com.br/news/1941243.webp",
    "thumb_id": ""
  },
  {
    "id": "50705",
  ...
  },
  {
    ...
    "categories": [],
    "tags": [],
    "image_url":  "https://www.ncbrasil.com.br/news/alamo.webp",
    "thumb_id": ""
  },
  {
    "id": "50766",
  ...
  },
  {
    ...
    "categories": [],
    "tags": [],
    "image_url":  "https://www.ncbrasil.com.br/news/imóveis.jpg.jpeg",
    "thumb_id": ""
  },
  {
    "id": "50865",
